    ...
    <>
      ...
      >
        <div className="container booking-layout">
            ...
            >
              <form onSubmit={handleBooking}>
                ...
                >
                  ...
                  <option value="beginner">{t("home.booking.beginner")}</option>
                  <option value="intermediate">{t("home.booking.intermediate")}</option>
                  <option value="advanced">{t("home.booking.advanced")}</option>
                </select>
                ...
                >
                  {isSubmitting ? "SENDING..." : t("home.booking.submit")}
                  {!isSubmitting && <>&nbsp; ›</>}
                </button>
              </form>
            </div>
          ...
          <div className="booking-copy booking-contacts">
